...
for page in range(totalPages):
    ...
    for x in range(pageWidth+2*marginX+extraX*2):
        ...
        curveTo((CurrentXdeltaCurve, Y1), (CurrentXdeltaCurve, Y1), (CurrentX, Ymiddle))
        curveTo((CurrentXdeltaCurve, Y3), (CurrentXdeltaCurve, Y4), (CurrentX, Ymax))
        lineTo((CurrentX+errorMargin+baseShapeWidth, Ymax))
        curveTo((CurrentXdeltaCurve+errorMargin+baseShapeWidth, Y4), (CurrentXdeltaCurve+errorMargin+baseShapeWidth, Y3), (CurrentX+errorMargin+baseShapeWidth, Ymax))
        curveTo((CurrentXdeltaCurve+errorMargin+baseShapeWidth, Y2), (CurrentXdeltaCurve+errorMargin+baseShapeWidth, Y1), (CurrentX+errorMargin+baseShapeWidth, Ymiddle))
