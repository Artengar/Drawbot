    ...
    for item in range(amountOfAnimations):
        ...
        for item in range(len(progressList)):
            ...
            if item ==0:
                ...
                path.curveTo(
                    (segmentStartPointX+progressList[item]*0.55229*correctorWidth*scale*scale2, segmentStartPointY),
                    (segmentStartPointX+progressList[item]*correctorWidth*scale*scale2, segmentStartPointY-progressList[item]*0.44771*correctorHeight*scale*scale2),
                    (segmentStartPointX+progressList[item]*correctorWidth*scale*scale2, segmentStartPointY-progressList[item]*correctorHeight*scale*scale2) )
        
                segmentStartPointX=segmentStartPointX+progressList[item]*correctorWidth*scale*scale2
                segmentStartPointY=segmentStartPointY-progressList[item]*correctorHeight*scale*scale2
        
            elif sin(radians(item*90)) == 1 or cos(radians(item*90)) == 0:
                path.curveTo(
                    (segmentStartPointX, segmentStartPointY-progressList[item]*0.55229*correctorHeight*scale*scale2),
                    (segmentStartPointX-progressList[item]*0.44771*correctorWidth*scale*scale2, segmentStartPointY-progressList[item]*correctorHeight*scale*scale2),
                    (segmentStartPointX-progressList[item]*correctorWidth*scale*scale2, segmentStartPointY-progressList[item]*correctorHeight*scale*scale2) )
