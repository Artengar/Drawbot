...
for thisInstance in myFont.instances:#takes only the active instances from Glyphs
    ...
    footer=pageNumber + ' Test print. This Drawbot script © Maarten Renckens. Freely available at Github: github.com/Artengar/Glyphs
    font("Helvetica")
    textBox(header,(0,800,535,30), align="center")#(x, y, w, h)
    textBox(footer,(0,0,535,30), align="center")#(x, y, w, h)
